...
const Referrals = () => {
  ...
  return (
    <div className="page-container" style={{ maxWidth: 960, margin: '0 auto' }}>
      ...
      {/* Hero */}
      <div className="glass-card" style={{ padding: 'var(--td-space-xl)', marginBottom: 'var(--td-space-lg)', textAlign: 'center', background: 'linear-gradient(135deg, var(--td-primary) 0%, #FF7A59 100%)', color: '#fff' }}>
        ...
        <p style={{ opacity: 0.9, maxWidth: 480, margin: '0 auto 20px' }}>
          Share your code with friends. When they join TrendDrop, you both earn {formatPrice(rewardAmount, 'USD')} in credit.
        </p>
