...
describe('AIStylist page', () => {

  const stubAll = () => {
  api.getAIPreferences.mockResolvedValue({ data: [] });
  api.getAIRecommendations.mockResolvedValue({ data: [] });
  api.getAITrends.mockResolvedValue({ data: [] });
  api.getUserOutfits.mockResolvedValue({ data: [] });
  };

  test('renders without crashing', async () => {
    stubAll();
    renderPage(<AIStylist />);
